...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 03 jan. 2020 à 13:01
...
INSERT INTO `cours` (`id`, `titre`, `id_prof`, `promo`, `date_h`, `description`) VALUES
(111, 'methodologies', 1, '1CS', '2020-01-02 13:26:25', 'cours1 module igl'),
(112, 'ethernet', 1, '1CS', '2020-01-02 13:29:47', 'module reseaux'),
(145, 'methodes iteratives', 1, '1CS', '2020-01-03 11:00:10', 'module anum');
...
(1, 20, 170147, 1, 1, 12, 11),
(2, 14, 170151, 1, 1, 13, 12),
(3, 7, 170124, 1, 0, 14, 13),
(4, 18, 170163, 1, 0, 19, 7),
(5, 15, 170219, 1, 0, 15, 15),
(6, 18, 170018, 1, 0, 12, 17);
...
--
ALTER TABLE `notes`
  ADD CONSTRAINT `notes_ibfk_1` FOREIGN KEY (`id_etud`) REFERENCES `eleve` (`id`);
